package com.jues.mediemuxerlibrary.gridImage;
 ...
 * PackageName : com.six.jues.salon.adapter
 * User : jues.
 * Date ：on 2017/7/31.
...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.drawable.ic_image_add);
...
//            viewHolder.tv_duration.setText(DateUtils.timeParse(duration));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mImg = (ImageView) view.findViewById(R.id.iv_pic);
